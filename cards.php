...
<head>
    ...
    <title>Quinton Pang's Projects</title>
</head>
<body>
    <header>
        <div class="menu-btn">
        ...
        <section class="projects">
           ...
           <div class="projects__items">
               <div class="projects__item">
                   <img src="img/project-1.png" alt="My Project">
               ...
               <div class="projects__item">
                   <img src="img/project-2.webp" alt="My Project">
                   <div class="projects__btns">
                       <a href="#" class="projects__btn">
                           <i class="fas fa-eye"></i>Preview
                       </a>
               ...
               <div class="projects__item">
                   <img src="img/project-5.webp" alt="My Project">
                   <div class="projects__btns">
                       <a href="#" class="projects__btn">
                           <i class="fas fa-eye"></i>Preview
                       </a>
               ...
               <div class="projects__item">
                   <img src="img/project-6.jpeg" alt="My Project">
                   <div class="projects__btns">
                       <a href="#" class="projects__btn">
                           <i class="fas fa-eye"></i>Preview
                       </a>
